  ...
  >
    ...
    <v-main>
      ...
      <v-footer app inset>
        <v-spacer></v-spacer>
        <div class="overline">
          Built with <v-icon small color="pink">mdi-heart</v-icon> <a class="text-decoration-none" href="https://www.linkedin.com/in/mostafa-gamal-9866381b7/" target="_blank">@Mostafa-Gamal</a>
        </div>
      </v-footer>
    </v-main>
  </div>
